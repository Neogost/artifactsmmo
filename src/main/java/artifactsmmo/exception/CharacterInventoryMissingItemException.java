...
public class CharacterInventoryMissingItemException extends RuntimeException{

    /**
     * Constructs a new {@code CharacterNotFoundException} with {@code null} as its detail message.
     */
    public CharacterInventoryMissingItemException() {
        super();
    }
     ...
     */
    public CharacterInventoryMissingItemException(String message) {
        super(message);
    }
     ...
     */
    public CharacterInventoryMissingItemException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *              by the {@link #getCause()} method.
     */
    public CharacterInventoryMissingItemException(Throwable cause) {
        super(cause);
    }
}
